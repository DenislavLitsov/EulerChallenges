...
namespace Challenge11
{
    internal class Program
    {
        ...
        static int GetLargestProduct(int x, int y)
        {
            int product1 = 0;
            int product2 = 0;
            int product3 = 0;
